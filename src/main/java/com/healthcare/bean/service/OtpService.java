...
public class OtpService {
    ...
    // ----------------------    This is Genrate Otp on Email

//    public void generateAndSendEmailOtp(String emailId) {
//        String otp = generateOtp(emailId); // Your existing method
//        otpStorage.put(emailId, otp); // Store in map
//
//        emailService.sendOtpEmail(emailId, otp); // Send email
//    }
